	...
	<div id="screen-meta" class="metabox-prefs">
		<div id="contextual-help-wrap" class="hidden">
			...
			<div id="contextual-help-columns">
				<div class="contextual-help-tabs"> <!-- Menu / colonne 1-->
					<ul>
				...
				<div class="contextual-help-sidebar"> <!-- plus d'informations / colonne 3-->
					<p>
						<strong>Plus d&rsquo;informations&nbsp;:</strong></p><p><a href="" target="_blank">Documentation sur le tableau de bord (en)</a></p><p><a href="" target="_blank">Forums d&rsquo;entraide</a>
					</p>
				</div>
                  
				<div class="contextual-help-tabs-wrap"> <!-- les textes / colonne centrale-->
					<div id="tab-panel-overview" class="active help-tab-content">
						<p>
							Bienvenu dans votre tableau de bord ! Ceci est l&rsquo;écran que vous verrez lorsque vous vous connectez à votre site, et qui vous donne accès à l&rsquo;ensemble des fonctionnalités de gestion de WordPress. Vous pouvez obtenir de l&rsquo;aide dans n&rsquo;importe quel écran en cliquant sur l&rsquo;onglet « Aide » présent en haut à droite de votre navigateur.
						</p>
					</div>
                  
					<div id="tab-panel-help-navigation" class=" help-tab-content">
						<p>
							La navigation située à gauche de l&rsquo;écran fournit tous les liens pour accéder à la console d&rsquo;administration de WordPress, avec les sous-menus qui s&rsquo;affichant au survol. Vous pouvez réduire ce menu à ses seules icônes en cliquant sur la flèche de repliement située en bas du menu.
						</p>
						<p>
					...
					<div id="tab-panel-help-content" class=" help-tab-content">
						<p>
							Les modules de l&rsquo;écran du tableau de bord sont&nbsp;:</p><p><strong>Aujourd&rsquo;hui</strong> - Affiche un résumé du contenu de votre site, et indique le thème et la version de WordPress que vous utilisez.</p><p><strong>Commentaires récents</strong> - Affiche les commentaires les plus récents sur vos articles (configurable, jusqu&rsquo;à 30), et vous permet de les modérer directement.</p><p><strong>Liens entrants</strong> - Affiche les liens vers votre site, tels qu&rsquo;indiqués par Google Blog Search.</p><p><strong>Press-Minute</strong> - Crée un nouvel article rapidement, et de le publier directement ou de le garder comme brouillon.</p><p><strong>Brouillons récents</strong> - Affiche un lien vers les 5 derniers brouillons d&rsquo;articles que vous avez commencés.</p><p><strong>Blog de WordPress</strong> - Affiche les dernières nouvelles officielles du projet WordPress.</p><p><strong>Autres actualités de WordPress (en français)</strong> - Affiche le flux du <a href="http://www.wordpress-fr.net/planet/" target="_blank">Planet de WordPress</a>. Vous pouvez configurer ce module pour utiliser un autre flux de votre choix.</p><p><strong>Extensions</strong> - Affiche l&rsquo;extension la plus populaire, la plus récente et la plus récemment mise à jour, en provenance du dépôt d&rsquo;extensions de WordPress.org.
						</p>
					</div>
				</div>
			</div>
		</div>
			<div id="screen-options-wrap" class="hidden">options</div> <!-- Options écran -->
		</div>

		<div id="screen-meta-links"><!-- bouton2-->
			<div id="contextual-help-link-wrap" class="hide-if-no-js screen-meta-toggle">
				<a href="#contextual-help-wrap" id="contextual-help-link" class="show-settings">Aide</a>
			</div>

		<div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
			<a href="#screen-options-wrap" id="show-settings-link" class="show-settings">Options de l&rsquo;écran</a>
		</div>
	</div>
</div><!-- fin aide -->
