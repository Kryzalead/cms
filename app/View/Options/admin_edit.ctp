...
<div id="options_generales" class="bloc degrader options_form">
	...
	<?php echo $this->Form->create('Options') ?>
		<?php if ($action == 'general'): ?>
			...
			<?php echo $this->Form->input('Option.admin_email',array('label'=>"Adresse de messagerie",'after'=>'Cette adresse n’est utilisée que pour l’administration du site.<span class="souligner">Par exemple</span> : la notification de l’inscription d’un nouvel utilisateur.')); ?>
