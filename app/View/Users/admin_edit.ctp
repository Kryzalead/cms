...
<div id="form_user">
	<?php echo $this->Form->create('User') ?>
		...
		<div id="pass_strength_result" style="background-color: #EEE;border-color: #DDD!important;border-style: solid;border-width: 1px;text-align: center;width: 200px;line-height: 20px;height: 20px">
